      ...
      schemas: {
        ...
        GoalRequest: {
          ...
          properties: {
            ...
            walletId: { type: "string", format: "uuid", description: "Optional dedicated wallet UUID" },
