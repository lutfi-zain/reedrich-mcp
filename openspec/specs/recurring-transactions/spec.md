## Purpose
Provides recurring transaction templates with bounded planned-row materialization, flip-based realization, future-only propagation, and informational in-memory forward cashflow projection.
